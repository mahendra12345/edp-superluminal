...
use Laminas\Code\Reflection\ClassReflection,
    Laminas\Code\Scanner\FileScanner,
    Laminas\EventManager\StaticEventManager;
...
class Module
{
    ...
    public function init($e)
    {
        ...
        $events->attach('Laminas\Mvc\Application', 'finish', array($this, 'cache'));
    }
    ...
    public function cache($e)
    {
        ...
        foreach ($classes as $class) {
            ...
            if (in_array($class, array('Laminas\Loader\AutoloaderFactory', __CLASS__))) {
                continue;
            }
